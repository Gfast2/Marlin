...
// Please note these are limited to 17 characters!
	...
	#define WELCOME_MSG MACHINE_NAME			" ��芯��芯胁."
	#define MSG_SD_INSERTED						"��邪����邪 胁����邪胁谢械薪邪"
	#define MSG_SD_REMOVED						"��邪����邪 懈蟹胁谢械��械薪邪"
	#define MSG_MAIN							"��械薪��            \003"
	#define MSG_AUTOSTART						"��胁��芯����邪����"
	#define MSG_DISABLE_STEPPERS 				"����泻谢. 写胁懈谐邪��械谢懈"
	#define MSG_AUTO_HOME						"��邪��泻芯胁泻邪"
	#define MSG_SET_ORIGIN						"��邪锌芯屑薪懈���� 薪芯谢��"
	#define MSG_PREHEAT_PLA 					"����械写薪邪谐��械胁 PLA"
	#define MSG_PREHEAT_PLA_SETTINGS  			"��邪������芯泄泻懈 PLA"
	#define MSG_PREHEAT_ABS						"����械写薪邪谐��械胁 ABS"
	#define MSG_PREHEAT_ABS_SETTINGS  			"��邪������芯泄泻懈 ABS"
	#define MSG_COOLDOWN						"����谢邪卸写械薪懈械"
	#define MSG_SWITCH_PS_ON					"Switch Power On"
	#define MSG_SWITCH_PS_OFF					"Switch Power Off"
	#define MSG_EXTRUDE							"协泻��������蟹懈��"
	#define MSG_RETRACT							"����泻邪��"
	#define MSG_MOVE_AXIS  						"��胁懈卸械薪懈械 锌芯 芯����屑"
	#define MSG_MOVE_X                          "Move X"
	#define MSG_MOVE_Y                          "Move Y"
	#define MSG_MOVE_Z                          "Move Z"
	#define MSG_MOVE_E                          "Extruder"
	...
	#define MSG_MOVE_1MM                        "Move 1mm"
	#define MSG_MOVE_10MM                       "Move 10mm"
	#define MSG_SPEED							"小泻芯��芯������:"
	#define MSG_NOZZLE							"\002 肖懈谢��械��邪:"
	#define MSG_NOZZLE1							"\002 肖懈谢��械��邪2:"
	#define MSG_NOZZLE2							"\002 肖懈谢��械��邪3:"
	#define MSG_BED								"\002 ����芯胁邪����:"
	#define MSG_FAN_SPEED						"����谢谢械��:"
	#define MSG_FLOW							"��芯��芯泻:"
	#define MSG_CONTROL							"��邪������芯泄泻懈 \003"
	#define MSG_MIN								"\002 ��懈薪懈屑��屑:"
	#define MSG_MAX								"\002 ��邪泻��懈屑��屑:"
	#define MSG_FACTOR							"\002 肖邪泻��芯��:"
	#define MSG_AUTOTEMP						"Autotemp:"
	#define MSG_ON								"��泻谢. "
	#define MSG_OFF								"����泻谢. "
	#define MSG_PID_P							"PID-P: "
	...
	#define MSG_AMAX							"Amax "
	#define MSG_A_RETRACT						"A-retract:"
	#define MSG_XSTEPS							"X ��邪谐/mm:"
	#define MSG_YSTEPS							"Y ��邪谐/mm:"
	#define MSG_ZSTEPS							"Z ��邪谐/mm:"
	#define MSG_ESTEPS							"E ��邪谐/mm:"
	#define MSG_RECTRACT    					"����泻邪�� 锌芯写邪��懈    \x7E"
	#define MSG_TEMPERATURE  					"孝械屑锌械��邪������邪     \x7E"
	#define MSG_MOTION							"小泻芯��芯����懈        \x7E"
	#define MSG_CONTRAST  						"LCD contrast"
	#define MSG_STORE_EPROM  					"小芯����邪薪懈���� 胁 EPROM"
	#define MSG_LOAD_EPROM  					"��邪谐����蟹. 懈蟹 EPROM"
	#define MSG_RESTORE_FAILSAFE				"小斜��芯�� 薪邪������芯械泻"
	#define MSG_REFRESH							"\004��斜薪芯胁懈����"
	#define MSG_WATCH							"��斜蟹芯��           \003"
	#define MSG_PREPARE							"��械泄����胁懈��        \x7E"
	#define MSG_TUNE							"��邪������芯泄泻懈       \x7E"
	#define MSG_RESUME_PRINT  					"����芯写芯谢卸懈���� 锌械��邪����"
	#define MSG_RESUME_PRINT					"����芯写芯谢卸懈���� 锌械��邪����"
	#define MSG_STOP_PRINT 						"������邪薪芯胁懈���� 锌械��邪����"
	#define MSG_CARD_MENU						"��械薪�� 泻邪������      \x7E"
	#define MSG_NO_CARD							"��械�� 泻邪������"
	#define MSG_DWELL							"小芯薪..."
	#define MSG_USERWAIT  						"��卸懈写邪薪懈懈械"
	#define MSG_RESUMING 						"Resuming print"
	#define MSG_NO_MOVE							"��械�� 写胁懈卸械薪懈��."
	#define MSG_KILLED							"校����孝��."
	#define MSG_STOPPED							"��小孝����������������."
	#define MSG_CONTROL_RETRACT					"����泻邪�� mm:"
	#define MSG_CONTROL_RETRACTF				"����泻邪��  F:"
	#define MSG_CONTROL_RETRACT_ZLIFT			"������卸芯泻 mm:"
	#define MSG_CONTROL_RETRACT_RECOVER			"��芯蟹胁��邪�� +mm:"
	#define MSG_CONTROL_RETRACT_RECOVERF		"��芯蟹胁��邪��  F:"
	#define MSG_AUTORETRACT						"��胁��芯����泻邪��:"
	#define MSG_FILAMENTCHANGE 					"Change filament"
	#define MSG_INIT_SDCARD 					"Init. SD-Card"	
	#define MSG_CNG_SDCARD 						"Change SD-Card"
    #define MSG_ZPROBE_OUT 						"Z probe out. bed"
...
// Serial Console Messages
	...
	#define MSG_Enqueing						"��邪锌谢邪薪懈��芯胁邪薪芯 \""
	#define MSG_POWERUP							"��泻谢����械薪懈械 锌懈��邪薪懈��"
	#define MSG_EXTERNAL_RESET					" ��薪械��薪懈泄 ��斜��芯��"
	#define MSG_BROWNOUT_RESET					" Brown out ��斜��芯��"
	#define MSG_WATCHDOG_RESET					" Watchdog ��斜��芯��"
	#define MSG_SOFTWARE_RESET					" 锌��芯谐��邪屑屑薪��泄 ��斜��芯��"
	#define MSG_AUTHOR							" | ��胁��芯��: "
	#define MSG_CONFIGURATION_VER				" ��芯��谢械写薪械械 芯斜薪芯胁谢械薪懈械: "
	#define MSG_FREE_MEMORY						" ��邪屑����懈 ��胁芯斜芯写薪芯: "
	#define MSG_PLANNER_BUFFER_BYTES			"  ��������械�� 芯��械��械写懈 泻芯屑邪薪写 Bytes: "
	#define MSG_OK								"ok"
	#define MSG_FILE_SAVED						"肖邪泄谢 蟹邪锌懈��邪薪."
	#define MSG_ERR_LINE_NO						"��芯屑械薪 ������芯泻懈 ����芯 薪械 锌芯��谢械写薪���� ������芯泻邪+1, 锌芯��谢械写薪���� ������芯泻邪:"
	#define MSG_ERR_CHECKSUM_MISMATCH			"泻芯薪����芯谢��薪邪�� ����屑屑邪 薪械 ��芯胁锌邪写邪械��, 锌芯��谢械写薪���� ������芯泻邪:"
	#define MSG_ERR_NO_CHECKSUM					"薪械�� 泻芯薪����芯谢��薪芯泄 ����屑屑�� 写谢�� ������芯泻懈, 锌芯��谢械写薪���� ������芯泻邪:"
	#define MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM	"薪械�� ������芯泻懈 写谢�� 泻芯薪����芯谢��薪芯泄 ����屑屑��, 锌芯��谢械写薪���� ������芯泻邪:"
	#define MSG_FILE_PRINTED					"��械��邪���� ��邪泄谢邪 蟹邪胁械����械薪邪"
	#define MSG_BEGIN_FILE_LIST					"小锌懈��芯泻 ��邪泄谢芯胁"
	#define MSG_END_FILE_LIST					"��芯薪械�� ��锌懈��泻邪 ��邪泄谢芯胁"
	#define MSG_M104_INVALID_EXTRUDER			"M104 芯��懈斜泻邪 ��泻��������写械��邪 "
	#define MSG_M105_INVALID_EXTRUDER			"M105 芯��懈斜泻邪 ��泻��������写械��邪 "
	#define MSG_M200_INVALID_EXTRUDER			"M200 芯��懈斜泻邪 ��泻��������写械��邪 "
	#define MSG_M218_INVALID_EXTRUDER			"M218 芯��懈斜泻邪 ��泻��������写械��邪 "
	#define MSG_ERR_NO_THERMISTORS				"��械�� ��械��屑懈������邪 - 薪械�� ��械屑锌械��邪��������"
	#define MSG_M109_INVALID_EXTRUDER			"M109 芯��懈斜泻邪 ��泻��������写械��邪 "
	#define MSG_HEATING							"��邪谐��械胁...  "
	#define MSG_HEATING_COMPLETE				"��邪��谐械��芯.    "
	#define MSG_BED_HEATING						"��邪谐��械胁 ����芯谢邪...     "
	#define MSG_BED_DONE						"小��芯谢 薪邪谐��械��.        "
	#define MSG_M115_REPORT						"FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
	#define MSG_COUNT_X							" Count X:"
	#define MSG_ERR_KILLED						"����懈薪��械�� 芯����邪薪芯胁谢械薪. 胁��蟹芯胁 kill() !!"
	#define MSG_ERR_STOPPED						"����懈斜泻邪 锌��懈薪��械��邪, 芯����邪薪芯胁. 校������邪薪懈��械 薪械懈��锌��邪胁薪芯������ 懈 懈��锌芯谢��蟹��泄��械 M999 写谢�� 锌械��械蟹邪谐����蟹泻懈!. (孝械屑锌械��邪������邪 薪械写芯������锌薪邪. ����芯胁械������械 写邪����懈泻懈)"
	#define MSG_RESEND							"��械��械芯��锌��邪胁泻邪:"
	#define MSG_UNKNOWN_COMMAND					"��械懈蟹胁械����薪邪�� 泻芯屑邪薪写邪:\""
	#define MSG_ACTIVE_EXTRUDER					"��泻��懈胁薪��泄 ��泻��������写械��: "
	#define MSG_INVALID_EXTRUDER				"����懈斜泻邪 ��泻��������写械��邪"
	#define MSG_X_MIN							"x_min:"
	#define MSG_X_MAX							"x_max:"
	#define MSG_Y_MIN							"y_min:"
	#define MSG_Y_MAX							"y_max:"
	#define MSG_Z_MIN							"z_min:"
	#define MSG_Z_MAX							"z_max:"
	#define MSG_M119_REPORT						"小��邪������ 泻芯薪��械胁懈泻芯胁"
	#define MSG_ENDSTOP_HIT						"小��邪斜邪����胁邪薪懈械 泻芯薪��械胁懈泻邪"
	#define MSG_ENDSTOP_OPEN					"��芯薪��械胁懈泻 芯��胁芯斜芯卸写械薪"
	#define MSG_HOTEND_OFFSET					"Hotend offsets:"
	#define MSG_SD_CANT_OPEN_SUBDIR				"��械 芯��泻�������� 锌邪锌泻��"
	#define MSG_SD_INIT_FAIL					"����懈斜泻邪 懈薪懈��懈邪谢懈蟹邪��懈懈 SD"
	#define MSG_SD_VOL_INIT_FAIL				"����懈斜泻邪 懈薪懈��懈邪谢懈蟹邪��懈懈 ��邪蟹写械谢邪"
	#define MSG_SD_OPENROOT_FAIL				"��械 锌��芯��械������ ��芯写械��卸懈屑芯械 泻芯��薪��"
	#define MSG_SD_CARD_OK						"SD 泻邪����邪 胁 锌芯����写泻械"
	#define MSG_SD_WORKDIR_FAIL					"薪械 芯��泻�������� ��邪斜芯������ 锌邪锌泻��"
	#define MSG_SD_OPEN_FILE_FAIL				"����懈斜泻邪 ����械薪懈��, ��邪泄谢: "
	#define MSG_SD_FILE_OPENED					"肖邪泄谢 芯��泻������:"
	#define MSG_SD_SIZE							" ��邪蟹屑械��:"
	#define MSG_SD_FILE_SELECTED				"肖邪泄谢 胁��斜��邪薪"
	#define MSG_SD_WRITE_TO_FILE				"��邪锌懈���� 胁 ��邪泄谢: "
	#define MSG_SD_PRINTING_BYTE				"SD 锌械��邪���� byte "
	#define MSG_SD_NOT_PRINTING					"薪械�� SD 锌械��邪��懈"
	#define MSG_SD_ERR_WRITE_TO_FILE			"芯��懈斜泻邪 蟹邪锌懈��懈 胁 ��邪泄谢"
	#define MSG_SD_CANT_ENTER_SUBDIR			"��械 蟹邪泄��懈 胁 锌邪锌泻��:"
	#define MSG_STEPPER_TOO_HIGH				"效邪����芯��邪 ��邪谐芯胁 芯��械薪�� 胁����芯泻邪 : "
	#define MSG_ENDSTOPS_HIT					"泻芯薪��械胁懈泻 ����邪斜芯��邪谢: "
	#define MSG_ERR_COLD_EXTRUDE_STOP			" 蟹邪��懈��邪 ��芯谢芯写薪芯泄 ��泻��������蟹懈懈"
	#define MSG_ERR_LONG_EXTRUDE_STOP			" 蟹邪��懈��邪 锌��械胁����械薪懈�� 写谢懈薪薪�� ��泻��������蟹懈懈"
	#define MSG_BABYSTEPPING_X "Babystepping X"
	#define MSG_BABYSTEPPING_Y "Babystepping Y"
	#define MSG_BABYSTEPPING_Z "Babystepping Z"
	#define MSG_SERIAL_ERROR_MENU_STRUCTURE "Error in menu structure"
